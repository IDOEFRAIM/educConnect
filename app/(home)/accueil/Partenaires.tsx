  ...
  return (
    <>
     ...
     <p className="text-lead text-gray-500 mb-5 text-center">Nous tenons encore a remercier nos partenaires qui nous ont fait confiance!</p>
      <div className="grid  gap-y-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center">
        <PartenaireCard className='md' name='DevSciences' imageUrl='/susan-q-yin-2JIvboGLeho-unsplash.jpg' />
        <PartenaireCard className='md' name='DevSciences' imageUrl='/susan-q-yin-2JIvboGLeho-unsplash.jpg' />
        <PartenaireCard className='md' name='DevSciences' imageUrl='/susan-q-yin-2JIvboGLeho-unsplash.jpg' />
        <PartenaireCard className='md' name='DevSciences' imageUrl='/susan-q-yin-2JIvboGLeho-unsplash.jpg' />
        <PartenaireCard className='md' name='DevSciences' imageUrl='/susan-q-yin-2JIvboGLeho-unsplash.jpg' />
  ...
  return(
    <div className="w-[320px]  flex flex-col">
      <div className="w-[300px] h-[400px] "
              ...
              >
        <h1 className="text-sky-600 text-lg">Informatique</h1> 
      </div>
      <div className="mx-5">
